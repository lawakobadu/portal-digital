...
while True:
    ...
    for (x, y, w, h) in plates:
        ...
        if area > min_area:
            ...
            # Menggunakan Tesseract OCR untuk mengenali karakter di dalam nomor plat
            plate_text = pytesseract.image_to_string(img_roi, config='--psm 7')
            print("Nomor Plat: ", plate_text)
